...
const Estimate = () => {
  ...
  const navigationForwardDisabled = () => {
    ...
    if (currentlyActive[0].id === questionsLength) {
      return true;
    } else {
      return false;
    }
  ...
  return (
    <Grid container direction="row">
      ...
      >
        <Grid
          item
          style={{ marginTop: "2em", marginLeft: matchesMD ? 0 : "3em" }}
        >
      ...
      <Grid
        ...
        container
        direction="column"
        style={{ marginRight: matchesMD ? 0 : "2em", marginBottom: "7em" }}
        lg
        alignItems="center"
      >
        {questions
          ...
          >
            ...
            >
              ...
              <Grid
                item
                style={{
                  margin: matchesSM || matchesMD ? "0 auto" : undefined,
                }}
              >
                <Button
                  variant="contained"
