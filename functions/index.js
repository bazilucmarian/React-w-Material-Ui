  ...
  return cors(request, response, () => {
    ...
    if (total) {
      if (category) {
        ...
        transporter.sendMail(mailOptionsSendToCeo, (error) => {
          if (error) {
            response.send(error);
          } else {
        ...
        mailOptionsSendToCeo = {
          ...
          <p style="font-size:16px">${message}</p>
           <p style="font-size:16px">${total}</p>
           <p style="font-size:16px">${service}</p>
           <p style="font-size:16px">${platforms}</p>
           <p style="font-size:16px">${features}</p>
           <p style="font-size:16px">${customFeatures}</p>
      ...
      const mailOptionsSendToUser = {
        from: "Arc Development",
        to: email,
        subject: "We have reveived your message!",
        html: `
      ...
      transporter.sendMail(mailOptionsSendToUser);
    } else {
      const mailOptionsSendToCeo = {
        from: "Arc Development",
        to: "bazilucm@gmail.com",
